...
c(3) = uicontrol('Style','pushbutton','Units','normalized','Position',...
    ...
    '[Patient,Pathology,Treatment,Session,Condition] = mergeConditions(temp,a,b); f = reportKinematics(Patient,Session,Condition,pluginFolder,normFolder,norm);filename = ''kinematics''; generatePdf(d,f,pluginFolder,patientFolder,filename);');
