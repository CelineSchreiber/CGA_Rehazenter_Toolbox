...
if Event.LHS(1) < Event.RHS(1)
    ...
    Spatiotemporal.L_Double_Support2 = (Event.LTO(1) - Event.RHS(1)) ...
        * 100/(Event.LHS(2) - Event.LHS(1));
    Spatiotemporal.Double_SupportTotal = mean([Spatiotemporal.L_Double_Support1+...
        Spatiotemporal.L_Double_Support2 Spatiotemporal.R_Double_Support1+...
        Spatiotemporal.R_Double_Support2]);
...
Spatiotemporal.Velocity = mean([abs(Vmarker.R_HJC(1,:,Event.RHS(2))-Vmarker.R_HJC(1,:,Event.RHS(1)))/Spatiotemporal.R_Gait_Cycle, ...
            abs(Vmarker.L_HJC(1,:,Event.LHS(2))-Vmarker.L_HJC(1,:,Event.LHS(1)))/Spatiotemporal.L_Gait_Cycle]);
