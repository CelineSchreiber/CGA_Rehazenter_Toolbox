...
Translation = T(1:3,4,:);
if max(abs(Rotation(1,3,:)*180/pi)) > 150
    Segment(5).FE = (mod(Rotation(1,3,:),2*pi)-pi)*180/pi;
else
    Segment(5).FE = Rotation(1,3,:)*180/pi;
end
if max(abs(Rotation(1,2,:)*180/pi)) > 150
    Segment(5).AA = -(mod(Rotation(1,2,:),2*pi)-pi)*180/pi; % *(-1)
else
...
if max(abs(Rotation(1,3,:)*180/pi)) > 150
    Segment(2).IER = (mod(Rotation(1,2,:),2*pi)-pi)*180/pi;
else
...
if max(abs(Rotation(1,2,:)*180/pi)) > 150
    Segment(102).IER = (mod(Rotation(1,2,:),2*pi)-pi)*180/pi;
else
